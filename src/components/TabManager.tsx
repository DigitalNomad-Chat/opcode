  ...
  return (
    ...
    >
      ...
      <button
        ...
        title={t('tabs.close.title', { title: tab.title })}
        tabIndex={-1}
      >
        <X className="w-3 h-3" />
      </button>
      ...
      >
        <div className="flex items-stretch h-8">
          ...
          <motion.button
            ...
            title={canAddTab() ? t('tabs.new.project') : t('tabs.max.reached')}
          >
